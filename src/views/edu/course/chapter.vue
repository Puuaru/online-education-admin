<template>
  <div class="app-container">
    ...
    <el-button type="text" @click="chapterOpenAdd()" icon="el-icon-plus"
      >添加章节</el-button
    >

    <!-- 章节信息弹框 -->
    <el-dialog title="章节信息填写" :visible.sync="dialogChapter">
      <el-form
        :model="chapter"
        ref="chapter"
        label-width="120px"
      ...
      >
        ...
        <el-form-item label="章节排序">
          <el-input-number v-model="chapter.sort" :min="0"></el-input-number>
        </el-form-item>
      </el-form>
      <div class="dialog-footer" slot="footer">
        <el-button @click="dialogChapter = false">取消</el-button>
        <el-button type="primary" @click="chapterDialogPost()">确定</el-button>
      </div>
    </el-dialog>

    <!-- 小节信息弹框 -->
    <el-dialog title="小节信息填写" :visible.sync="dialogVideo">
      <el-form
        :model="video"
        ref="video"
        label-width="120px"
      ...
      <div class="dialog-footer" slot="footer">
        ...
        <el-button type="primary" @click="videoDialogPost()">确定</el-button>
      </div>
    </el-dialog>
