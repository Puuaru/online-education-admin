<template>
  <div class="app-container">
    <h2>讲师信息管理</h2>
    <el-form ref="teacher" :model="teacherData" label-width="80px">
      ...
      <el-form-item label="讲师头衔">
        <el-select v-model="teacherData.level" placeholder="请选择讲师头衔">
          <el-option
      ...
      <el-form-item label="讲师介绍">
        <el-input type="textarea" v-model="teacherData.intro"></el-input>
      </el-form-item>
